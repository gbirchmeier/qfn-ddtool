        ...
        public static string GetBaseType(DDField field)
        {
            ...
            switch (qfnFieldClass)
            {
                ...
                default:
                    ...
                    throw new ApplicationException($"Unsupported QfnFieldClass: {qfnFieldClass}");
            }
        }

        public static string GetBaseClassType(DDField field)
        {
            var qfnFieldClass = GetQfnFieldClass(field);
            return qfnFieldClass.ToString();
        }
    }
}
