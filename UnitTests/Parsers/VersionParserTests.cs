...
namespace UnitTests.Parsers
{
    ...
    public class VersionParserTests
    {
        ...
        {
            var dd = ParserTestUtil.ReadDD("<fix major='4' minor='4'/>", VersionParser.SetVersionInfo);
            Assert.AreEqual("4.4 [] False", $"{dd.MajorVersion}.{dd.MinorVersion} [{dd.ServicePack}] {dd.IsFIXT}");
            Assert.AreEqual("FIX.4.4", dd.Identifier);

            dd = ParserTestUtil.ReadDD("<fix major='5' type='FIX' servicepack='0' minor='0'/>", VersionParser.SetVersionInfo);
            ...
            dd = ParserTestUtil.ReadDD("<fix major='5' type='FIX' servicepack='2' minor='0'/>", VersionParser.SetVersionInfo);
            ...
            dd = ParserTestUtil.ReadDD("<fix type='FIXT' major='1' minor='1' servicepack='0'/>", VersionParser.SetVersionInfo);
